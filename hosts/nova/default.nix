...
in {
  ...
  boot.loader = {
    ...
    # Grub (as opposed to systemd-boot) allows for os-prober to detect other
    # operating systems and add them to the boot menu.
    grub = {
      enable = true;
      theme = pkgs.nixos-grub2-theme;
      efiSupport = true;
      # HACK: Otherwise /boot/EFI/BOOT/BOOTX64.EFI isn't generated
